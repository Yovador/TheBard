    ...
    return (
        <center>
            <div>
                ...
                <Item imgPath={Info[1].imgPath} info={Info[1].elementSub} viewId={Info[0].viewId}> {Info[1].elementName}</Item>
                <Item imgPath={Info[2].imgPath} info={Info[2].elementSub} viewId={Info[0].viewId} > {Info[2].elementName}</Item>
            </div>
        </center>
      );
